...
class User extends Authenticatable {
    ...
    protected $fillable = [
        ...
        'can_view_maintenance_parts','can_view_products','can_view_mobile_shop','is_mobile_shop_only','can_view_online_orders',
        'can_view_community',
    ];
    ...
    protected function casts(): array {
        return [
            ...
            'can_view_mobile_shop' => 'boolean',
            'is_mobile_shop_only' => 'boolean',
            'can_view_online_orders' => 'boolean',
    ...
    public function canViewSection(string $key): bool {
        ...
        $map = [
            ...
            'online_orders' => 'can_view_online_orders',
            'community' => 'can_view_community',
        ];
        $column = $map[$key] ?? null;

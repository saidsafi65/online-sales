...
@section('content')
    ...
    @unless ($__hasAnySection)
        <div style="background: white; border-radius: 16px; padding: 2rem; text-align: center; color: #64748b; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
            ما عندك صلاحية وصول لأي قسم حالياً. تواصل مع مدير النظام لتفعيل الصلاحيات المطلوبة.
        </div>
    @endunless
    ...
    <div class="row g-4 justify-content-center">
        <!-- المبيعات -->
        @if (auth()->user()->canViewSection('sales'))
        ...
        <!-- الصيانة -->
        @if (auth()->user()->canViewSection('repairs'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        <!-- المشتريات -->
        @if (auth()->user()->canViewSection('purchases'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        <!-- الكتالوج -->
        @if (auth()->user()->canViewSection('catalog'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        <!-- أمانات الصيانة -->
        @if (auth()->user()->canViewSection('deposits'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        <!-- التقارير -->
        @if (auth()->user()->canViewSection('reports'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        @if (auth()->user()->canViewSection('obligations'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        @endif
        <!-- الفواتير -->
        @if (auth()->user()->canViewSection('invoices'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        @endif
        <!-- التوافقات -->
        @if (auth()->user()->canViewSection('compatibility'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        @endif
        <!-- طلبات الزبائن -->
        @if (auth()->user()->canViewSection('customer_orders'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        @endif
        <!-- الطلبات الإلكترونية -->
        @if (auth()->user()->canViewSection('online_orders'))
        <div class="col-12 col-sm-6 col-lg-4">
            <a href="{{ route('online-orders.index') }}" class="text-decoration-none">
                <div class="service-card card-warning">
                    <div class="service-icon">
                        <i class="fas fa-shopping-bag"></i>
                    </div>
                    <h3 class="service-title">الطلبات الإلكترونية</h3>
                    <p class="service-description">متابعة طلبات العملاء من الموقع الإلكتروني وتحديث حالتها</p>
                </div>
            </a>
        </div>
        @endif
        ...
        <!-- التسليمات اليومية -->
        @if (auth()->user()->canViewSection('daily_handovers'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        <!-- البضائع المرجعة -->
        @if (auth()->user()->canViewSection('returned_goods'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        @endif
        <!-- المخزن الخارجي -->
        @if (auth()->user()->canViewSection('store'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        @endif
        <!-- الديون -->
        @if (auth()->user()->canViewSection('debts'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        @endif
        <!-- النسخ الاحتياطي -->
        @if (auth()->user()->canViewSection('backup'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        @endif
        <!-- قطع الصيانة -->
        @if (auth()->user()->canViewSection('maintenance_parts'))
        <div class="col-12 col-sm-6 col-lg-4">
        ...
        @endif
        <!-- المنتجات -->
        @if (auth()->user()->canViewSection('products'))
        <div class="col-12 col-sm-6 col-lg-4">
                    ...
                    <div class="col-6 col-md-3">
                        <div
                            ...
                            <div style="font-size: 1.5rem; font-weight: 800; color: #ca8a04; margin-bottom: 0.5rem;">
                                <div>لنا: {{ number_format($totalReceivables ?? 0) }} شيكل</div>
                                <div>علينا: {{ number_format($totalPayables ?? 0) }} شيكل</div>
                            </div>

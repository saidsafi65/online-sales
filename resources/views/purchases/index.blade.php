        ...
        <div class="card-body">
            <form method="GET" class="row g-3 mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" class="form-control" placeholder="ابحث بالصنف أو النوع أو اسم المورد أو رقم الجوال">
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped align-middle">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($purchase->id_image)
                                        <a href="/{{ $purchase->id_image }}" target="_blank" class="btn btn-sm btn-outline-info">عرض</a>
                                    @else
                                        -
                                    @endif
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('purchases.edit', $purchase) }}" class="btn btn-sm btn-outline-primary">تعديل</a>
                                    <form action="{{ route('purchases.destroy', $purchase) }}" method="POST" class="d-inline" onsubmit="return confirm('تأكيد الحذف؟');">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @empty
                            <tr><td colspan="15" class="text-center">لا توجد بيانات</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>

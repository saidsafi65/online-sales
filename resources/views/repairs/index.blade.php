                    ...
                    <tbody>
                        @forelse($repairs as $repair)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('repairs.edit', $repair) }}" class="btn btn-sm btn-outline-primary">تعديل</a>
                                    <form action="{{ route('repairs.destroy', $repair) }}" method="POST" class="d-inline" onsubmit="return confirm('تأكيد الحذف؟');">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @empty
                            <tr><td colspan="13" class="text-center">لا توجد بيانات</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>

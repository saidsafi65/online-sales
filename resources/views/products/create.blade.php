...
<div class="container">
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <p class="form-subtitle">أضف منتج جديد إلى متجرك</p>
        </div>
            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
                ...
                <div class="mb-4">
                    ...
                    <select name="catalog_item_id" id="catalogItemSelect" class="form-control" onchange="onCatalogLinkChange()">
                        <option value="">بدون ربط (المنتج بيبدأ متوفر افتراضيًا)</option>
                    ...
                    <div class="file-input-wrapper">
                        ...
                        <label for="image" class="file-input-label">
                            ...
                            <div class="file-input-text">
                                ...
                                <div class="sub">صيغ مقبولة: JPG, PNG, GIF</div>
                            </div>
                        </label>
                    </div>
...
<script>
    ...
    function onCatalogLinkChange() {
        ...
        const notice = document.getElementById('quantityLinkedNotice');
        const isLinked = select.value !== '';

        quantityInput.disabled = isLinked;
        notice.style.display = isLinked ? 'flex' : 'none';
    }

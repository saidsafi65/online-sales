...
<style>
    ...
    .filter-reset-btn:hover { color: #dc2626; }
...
<div class="container">
    ...
    <div class="filter-bar">
        <form method="GET" action="{{ route('products.index-admin') }}" class="filter-form">
            <div class="filter-input-wrap">
                <i class="fas fa-search"></i>
                <input type="text" name="search" value="{{ request('search') }}" placeholder="ابحث بالاسم أو التصنيف...">
            </div>
            ...
            <button type="submit" class="filter-submit-btn"><i class="fas fa-filter"></i> بحث</button>
            @if(request()->hasAny(['search','category']))
                <a href="{{ route('products.index-admin') }}" class="filter-reset-btn"><i class="fas fa-times"></i> إلغاء</a>
            @endif
        </form>
    </div>
    ...
    @else
        ...
        <div class="products-table-wrapper">
            <div class="empty-state" style="padding: 4rem 2rem;">
                ...
                @if(request()->hasAny(['search','category']))
                    <h3 style="color: #1e293b; font-size: 1.5rem; margin-bottom: 0.5rem;">لا توجد نتائج مطابقة</h3>
                    <p style="color: #64748b; margin-bottom: 1.5rem;">جرّب تعديل كلمة البحث أو التصنيف</p>
                    <a href="{{ route('products.index-admin') }}" class="btn-add-product">

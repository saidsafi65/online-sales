...
@section('title', 'بحث الإنترنت (للتوافقات)')

@section('content')
<div class="container-fluid">
    <div style="max-width: 700px; margin: 0 auto;">
        <h1 style="font-size: 2rem; font-weight: 900; margin-bottom: 0.5rem; color: #1e293b;">🔍 بحث الإنترنت (للتوافقات)</h1>
        <p style="color:#64748b; margin-bottom:1.5rem;">
            ...
            المواصفات المؤكدة يدوياً بنفس نموذج إضافة القطعة الموجود. البرنامج ما بيعبّي المواصفات لحاله تلقائياً —
            هاد مقصود، حتى ما توصل معلومة غلط لقطعة غيار حساسة.
        </p>
        ...
        <form method="POST" action="{{ route('google-search-settings.update') }}">
            ...
            <div class="alert alert-info" style="border-radius: 12px; font-size: 0.9rem;">
                💡 <strong>كيف تجيب المفتاح مجاناً؟</strong>

            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <strong>تنبيه:</strong>
                        <ul class="mb-0 mt-2">
                            <li>يجب أن يكون الملف بصيغة <strong>.sql</strong> أو <strong>.zip</strong></li>
                            <li>الحد الأقصى لحجم الملف: <strong>500 ميجابايت</strong></li>
                    ...
                    <form method="POST" action="{{ route('backup.storeUpload') }}" enctype="multipart/form-data" id="uploadForm">
                        ...
                        <div class="mb-4">
                            ...
                            <small class="form-text text-muted">
                                الملفات المدعومة: .sql أو .zip (حتى 500 ميجابايت)
                            </small>
                        </div>

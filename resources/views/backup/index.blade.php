            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        @if (session('details'))
                            <div class="card mb-3">
                                <div class="card-header py-2 d-flex justify-content-between align-items-center" style="cursor:pointer;" data-bs-toggle="collapse" data-bs-target="#backupDetails" role="button">
                                    <span><i class="fas fa-list-alt"></i> التفاصيل</span>
                                    <i class="fas fa-chevron-down"></i>
                                </div>
                                <div class="collapse" id="backupDetails">
                                    <pre class="card-body mb-0" style="white-space:pre-wrap; font-size:0.85rem; direction:ltr; text-align:left;">{{ session('details') }}</pre>
                                </div>
                            </div>
                        @endif

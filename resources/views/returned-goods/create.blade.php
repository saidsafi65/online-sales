            ...
            <form action="{{ route('returned-goods.store') }}" method="POST">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="issue_discovered_date" name="issue_discovered_date" class="form-control @error('issue_discovered_date') is-invalid @enderror" value="{{ old('issue_discovered_date') }}" required>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <select id="status" name="status" class="form-control @error('status') is-invalid @enderror" required>
                            ...
                            <option value="returned" {{ old('status') == 'returned' ? 'selected' : '' }}>تم الإرجاع</option>
                            <option value="resolved" {{ old('status') == 'resolved' ? 'selected' : '' }}>تم الحل</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror

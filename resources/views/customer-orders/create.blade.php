            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input type="text" 
                               ...
                               placeholder="مثال: Laptop HP 15s, MacBook Pro 2020"
                               required>
                    </div>
                    @error('device_type')
                        <span class="invalid-feedback">{{ $message }}</span>
                ...
                <div class="form-group">
                    ...
                    <textarea name="specifications" 
                              ...
                              placeholder="أدخل مواصفات الجهاز المطلوب: المعالج، الرام، التخزين، كرت الشاشة، إلخ..."
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('approximate_price') }}"
                                       placeholder="مثال: 2000-2500 شيكل"
                                       required>
                            </div>

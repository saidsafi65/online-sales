    ...
    <div class="col-12">
        <div class="service-card card-primary" style="padding: 1.5rem;">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <a href="{{ route('invoices.create') }}" class="btn btn-lg" style="background: linear-gradient(135deg, #1e40af 0%, #6366f1 100%); color: white; padding: 12px 30px; border-radius: 50px; border: none; font-weight: 600; box-shadow: 0 5px 15px rgba(30, 64, 175, 0.3); transition: all 0.3s ease;">
    ...
    <div class="col-lg-6 col-xl-4">
        <div class="service-card card-primary" style="height: 100%; display: flex; flex-direction: column;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 1.5rem;">
                <div>
                    <span style="background: linear-gradient(135deg, #1e40af 0%, #6366f1 100%); color: white; padding: 0.5rem 1rem; border-radius: 50px; font-size: 0.9rem; font-weight: 600; display: inline-block;">
                        {{ $invoice->invoice_number }}
                    </span>
                </div>
                <span style="background: #ecfdf5; color: #065f46; padding: 0.4rem 0.8rem; border-radius: 8px; font-size: 0.85rem; font-weight: 600;">
            ...
            <div style="margin-bottom: 1rem;">
                <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.75rem;">
                    <div style="width: 40px; height: 40px; background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); border-radius: 10px; display: flex; align-items: center; justify-content: center; color: #1e40af; font-size: 1.2rem;">
                        <i class="fas fa-user"></i>
                    </div>
                    <div>
                        <p style="margin: 0; font-size: 0.85rem; color: #64748b;">اسم العميل</p>
                        <p style="margin: 0; font-size: 1.1rem; font-weight: 600; color: #1e293b;">{{ $invoice->customer_name }}</p>
                    </div>
                </div>
            ...
            <div style="margin-top: auto; padding-top: 1.5rem; border-top: 2px dashed #e2e8f0;">
                <!-- الإجمالي قبل الخصم -->
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem; padding: 0.5rem; background: #f8fafc; border-radius: 8px;">
                    <span style="color: #64748b; font-weight: 500; font-size: 0.9rem;">الإجمالي قبل الخصم:</span>
                    <span style="font-size: 1.1rem; font-weight: 600; color: #475569;">{{ number_format($invoice->total_amount, 2) }} ₪</span>
                </div>

                <!-- الخصم -->
                @if($invoice->discount_amount > 0)
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem; padding: 0.5rem; background: #fef3c7; border-radius: 8px;">
                    <span style="color: #b45309; font-weight: 500; font-size: 0.9rem;">
                        <i class="fas fa-tag" style="margin-left: 0.25rem;"></i>
                        الخصم:
                    </span>
                    <span style="font-size: 1.1rem; font-weight: 600; color: #f59e0b;">- {{ number_format($invoice->discount_amount, 2) }} ₪</span>
                </div>
                @endif

                <!-- المبلغ النهائي -->
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; padding: 0.75rem; background: linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%); border-radius: 10px; box-shadow: 0 2px 8px rgba(16, 185, 129, 0.15);">
                    <span style="color: #065f46; font-weight: 600; font-size: 1rem;">
                        <i class="fas fa-money-bill-wave" style="margin-left: 0.25rem;"></i>
                        المبلغ النهائي:
                    </span>
                    <span style="font-size: 1.8rem; font-weight: 700; color: #10b981;">{{ number_format($invoice->afterDiscount_amount, 2) }} ₪</span>
                </div>
...
<div class="row">
    <div class="col-12">
        <div class="service-card card-primary" style="text-align: center; padding: 4rem 2rem;">
            ...
            <a href="{{ route('invoices.create') }}" class="btn btn-lg" style="background: linear-gradient(135deg, #1e40af 0%, #6366f1 100%); color: white; padding: 12px 30px; border-radius: 50px; border: none; font-weight: 600; box-shadow: 0 5px 15px rgba(30, 64, 175, 0.3); display: inline-flex; align-items: center; gap: 0.5rem;">

...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Central "mother" connection: tenant registry + sessions/cache/jobs, shared
        // across every store regardless of which tenant database is currently active
        // on the 'mysql' connection below.
        'central' => [
            'driver' => 'mysql',
